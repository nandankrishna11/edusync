/**
 * Footer Component
 * KVG College branded footer for all pages
 */
    ...
    <footer className="bg-gradient-to-r from-gray-900 via-blue-900 to-indigo-900 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              />
              <div>
                <h3 className="text-xl font-bold">{collegeConfig.appName}</h3>
                <p className="text-sm text-blue-200">{collegeConfig.name}</p>
              </div>
            </div>
            <p className="text-blue-100 italic mb-3">"{collegeConfig.motto}"</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href={collegeConfig.contact.website} target="_blank" rel="noopener noreferrer" 
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-gray-300">{collegeConfig.contact.phone}</span>
              </li>
              <li className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-blue-300 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-300">{collegeConfig.contact.email}</span>
              </li>
              <li className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-blue-300 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-300 text-xs">{collegeConfig.location}</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <div className="flex space-x-4 mt-2">
                ...
                {collegeConfig.social.instagram && (
                  <a href={collegeConfig.social.instagram} target="_blank" rel="noopener noreferrer"
                     className="text-gray-400 hover:text-white transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center md:text-right">
              <p className="text-sm text-gray-400">
                Affiliated to {collegeConfig.academic.affiliatedTo}
              </p>
              <p className="text-xs text-gray-500 mt-1">
                {collegeConfig.academic.accreditation} | {collegeConfig.academic.approvedBy}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-6 text-center">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} {collegeConfig.appName} - {collegeConfig.name}. All rights reserved.
          </p>
          <p className="text-xs text-gray-500 mt-2">
            Developed with ❤️ for {collegeConfig.name}
          </p>
        </div>
      </div>
    </footer>
